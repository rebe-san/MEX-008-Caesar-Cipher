window.cipher ={
  encode:(offset, string)=>{ /*esto es un objeto se tiene que crear dos metodos de cifrar y descifrar dentro de este objeto, los metodos son funciones un metodo esta dentro de un objeto*/ /*Declara la variable cadena y guarda el texto introducido en la misma variable*/
